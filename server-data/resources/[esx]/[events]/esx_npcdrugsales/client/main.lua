...
AddEventHandler('notifyc', function()
    ...
    if crossing ~= nil then
      ...
      TriggerServerEvent('esx_phone:send', "police", "Some suspicious activity is occurring on " .. streetName .. " and " .. crossing, true, {
        x = coords.x,
        y = coords.y,
        z = coords.z
      })
    else
      TriggerServerEvent('esx_phone:send', "police", "Some suspicious activity is occurring on " .. streetName, true, {
        x = coords.x,
        y = coords.y,
        z = coords.z
      })
